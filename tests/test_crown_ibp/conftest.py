"""Shared test infrastructure for CROWN-IBP tests."""
...
from bound_propagation.propagation import CROWNIBPPropagator
...
def propagate_crown_ibp(fn, region, example_input=None):
    """Trace *fn*, propagate CROWN-IBP, return the first LinearBounds."""
