...
class TestCROWNIBPComplexNonlinearities:
    ...
    def test_reciprocal_near_asymptote(self) -> None:
        ...
        bounds = propagate_crown_ibp(fn, region, example_input=torch.rand(3) + 0.5)
        check_soundness(fn, region, bounds)
    ...
    def test_log_near_asymptote(self) -> None:
        ...
        bounds = propagate_crown_ibp(fn, region, example_input=torch.rand(2) + 0.1)
        check_soundness(fn, region, bounds)
    ...
    def test_div_constant_over_abstract_near_asymptote(self) -> None:
        ...
        bounds = propagate_crown_ibp(fn, region, example_input=torch.rand(2) + 0.5)
        check_soundness(fn, region, bounds)


class TestCROWNIBPMultiInput:
...
class TestCROWNIBPDeepNonlinearDAG:
