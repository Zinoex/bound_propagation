...
from bound_propagation.propagation.linear_relaxations.cos import compute_cos_alpha_beta
...
class TestCosRelaxationPeriodicity:
    ...
    def test_shifted_by_period(self):
        ...
        alpha_lower1, beta_lower1, alpha_upper1, beta_upper1 = compute_cos_alpha_beta(lower1, upper1)
        alpha_lower2, beta_lower2, alpha_upper2, beta_upper2 = compute_cos_alpha_beta(lower2, upper2)
