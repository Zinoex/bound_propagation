...
from bound_propagation.propagation.linear_relaxations.relu import compute_relu_alpha_beta
...
class TestReLURelaxationSoundness:
    ...
    def test_all_positive(self):
        ...
        alpha_lower, beta_lower, alpha_upper, beta_upper = compute_relu_alpha_beta(lower, upper)
...
class TestReLURelaxationAdaptive:
    ...
    def test_adaptive_vs_standard_positive_heavy(self):
        ...
        alpha_l_std, beta_l_std, alpha_u_std, beta_u_std = compute_relu_alpha_beta(lower, upper, adaptive=False)
        alpha_l_adp, beta_l_adp, alpha_u_adp, beta_u_adp = compute_relu_alpha_beta(lower, upper, adaptive=True)
