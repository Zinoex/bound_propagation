...
from bound_propagation.propagation.linear_relaxations.constant_div import compute_constant_div_alpha_beta
...
def test_constant_div_positive_nominal_sound() -> None:
    ...
    alpha_lower, beta_lower, alpha_upper, beta_upper = compute_constant_div_alpha_beta(lower, upper, constant=6.0)
...
def test_constant_div_zero_constant_is_exact_zero() -> None:
    ...
    alpha_lower, beta_lower, alpha_upper, beta_upper = compute_constant_div_alpha_beta(lower, upper, constant=0.0)
...
def test_constant_div_broadcast_constant_tensor() -> None:
    ...
    alpha_lower, beta_lower, alpha_upper, beta_upper = compute_constant_div_alpha_beta(lower, upper, constant=constant)
