...
class BackwardLBPTanhStrategy(ForwardBoundingStrategy):
    """
    Backward LBP strategy for TANH operation.

    For tanh y = tanh(x), we use adaptive linear relaxations in backward mode.
    ...
    def compute_bounds(
        ...
        """
        Compute backward LBP bounds for tanh.
